...
require_once '../../controller/profileController.php';
$profile = new profileController ;
if(isset($_POST['deleteNotifi'])){
    if(!empty($_POST['deleteNotifi'])){

        $profile->deleteNotifi($_SESSION["userId"],$_POST['deleteNotifi']);
                        ...
                        foreach($res as $r){
                            ?>
                                ...
                                <div class="ms-2 me-auto">
                                    <div class="fw-bold"><?php echo $r['description']?></div>
                                    <?php echo $r['date']?>
                                </div>
                                <span class="">
                                    <form action="notifi.php" method="POST">
                                        <input type="hidden" name="deleteNotifi" value="<?php echo $r['date']?>">
