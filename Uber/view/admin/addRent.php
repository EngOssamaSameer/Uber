...
if(isset($_POST['rentPrice'])){
    if(!empty($_POST['rentPrice'])){
        if($_POST['rentKind'] == "Car"){
            $kind = 1;
        }else if($_POST['rentKind'] == "Scooter"){
            $kind = 2 ; 
        }else{
            $kind = 3 ;
        }
        if($serv->addRent($_POST['rentPrice'],$kind)){
        $rentAdded = true;  
        }
    }
...
<body>
          ...
          <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="addService.php">
                            <i class="bi bi-circle"></i><span>Add Serivce</span>
                        </a>
                    </li>
                    <li>
                        <a href="rents.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add New Rent</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add New Rent Form</h5>

              <!-- No Labels Form -->
            <form novalidate action="addRent.php" method="post" class="row g-3">
                <div class="col-md-4">
                    <input type="number" name="rentPrice" class="form-control" placeholder="Enter Price">
                </div>
                <div class="col-md-4">
                  <select name="rentKind" id="inputState" class="form-select">
                    <option>Car</option>
            ...
            <?php
                    if($rentAdded && !empty($_POST['rentPrice'])){
                        ?>
                            <div class="alert alert-info alert-dismissible fade show" role="alert">
                                You Added a new Rent <br>
                                Price of new rent is :<?php echo $_POST['rentPrice'] ?>
